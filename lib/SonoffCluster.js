...
class SonoffCluster extends Cluster {
    ...
    static get ATTRIBUTES() {
        return {
            ...
            inching_control_bits: {
                // Inching configuration bitmap (BITMAP32); declared by s-dimaio, not sniffer-validated.
                id: 0x001C,
                type: bitmap32
            },
            temperatureCalibration: {
                // Temperature calibration offset (Int16, units: 0.01 °C).
                // Sniffer-confirmed: iHost writes on SNZB-02WD — e.g. -100 = -1.0 °C, +200 = +2.0 °C.
                id: 0x2003,
                type: ZCLDataTypes.int16
            },
            humidityCalibration: {
                // Humidity calibration offset (Int16, units: 0.01 %RH).
                // Sniffer-confirmed: iHost writes on SNZB-02WD — e.g. +100 = +1.0 %RH.
                id: 0x2004,
                type: ZCLDataTypes.int16
            },
            network_led: {
            ...
            protocolDataReport: {
                // Raw protocol data report attribute (BUFFER); declared by s-dimaio, not sniffer-validated.
                id: 0x0022,
    ...
    // Suppress ZCL global defaultResponse — belt-and-suspenders alongside protocolDataResponse no-op
    onDefaultResponse() {}
}
