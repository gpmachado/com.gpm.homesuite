...
class TimeSilentBoundCluster extends BoundCluster {
  // Respond to localTime reads with current Unix time in seconds.
  // Devices that have a time-cluster output binding periodically read localTime;
  // returning undefined causes "not_implemented" log spam on every request.
  get localTime() {
