...
module.exports = {
  ...
  // 25 min = 2.5× the 10 min report interval.
  ...
  ZIGBEE_REPEATER_HEARTBEAT_MS: 90 * 60 * 1000,      // 90 min
  ...
  DOOR_SENSOR_HEARTBEAT_MS:     4 * 60 * 60 * 1000,  // 4 h (aligned with standard battery devices to avoid false offline)
